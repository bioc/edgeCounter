...
hyperactive Tn5 transposase inserts transposon into the genome and 
transposition frequency depends mainly on genome accessibility.
...
It interfaces with the `rtracklayer` Bioconductor package.
...
1. Perform common QC tests with the `ATACseqQC` package.
...
starting point. For suggestions on how to align and filter raw ATACseq 
sequencing reads, you may refer to common sources such as 
Galaxy ATACseq Guide
